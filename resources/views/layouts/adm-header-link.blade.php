...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('app-assets/images/logo.jpeg')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('app-assets/images/images/logo.jpeg')}}">
