													...
													<table class="image_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-bottom:15px;padding-top:30px;width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="left" style="line-height:10px"><a  style="outline:none" tabindex="-1"><img src="{{asset('app-assets/images/logo.jpg')}}" style="display: block; height: auto; border: 0; width: 187px; max-width: 100%;" width="187" alt="Logo" title="Logo"></a></div>
															</td>
														</tr>
													</table>
												</td>
															...
															<td class="pad" style="padding-left:20px;padding-right:10px;">
																<div style="font-family: sans-serif">
																	<div class style="font-size: 12px; mso-line-height-alt: 18px; color: #000000; line-height: 1.5; font-family: Oswald, Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;"><span style="font-size:16px;"><strong>DECLARACIÓN JURADA DE DATOS Y DOMICILIO LEGAL</strong></span></p>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td class="pad" style="padding-bottom:10px;padding-right:5px;padding-top:10px;">
																<div style="font-family: Arial, sans-serif">
																	<div class style="font-size: 12px; font-family: 'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
																		<p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size:16px;">Fecha : {{$fecha}}</span></p>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td class="pad" style="padding-bottom:5px;padding-top:5px;">
																<div style="font-family: Tahoma, Verdana, sans-serif">
																	<div class style="font-size: 12px; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
																		<p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">El que suscribe&nbsp;<strong>{{ $item->apellido_pa}} {{ $item->apellido_ma}}  {{ $item->nombres}}</strong>&nbsp;N° DNI&nbsp;<strong>{{ $item->numero_documento}}
                                                                        </strong>&nbsp;con domicilio actual en (Av./Clle./Mz./Lt. – Int/Dpto)&nbsp;<strong>{{  $item->direccion}}</strong>&nbsp;Distrito:&nbsp;<strong>{{  $item->distrito}}</strong>&nbsp;Provincia:&nbsp;<strong>{{  $item->provincia}}</strong><br>Teléfono:&nbsp;<strong>{{  $item->telefono}}</strong></p>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td class="pad" style="padding-bottom:10px;padding-right:10px;padding-top:20px;">
																<div style="font-family: Tahoma, Verdana, sans-serif">
																	<div class style="font-size: 12px; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #000000; line-height: 1.2;">
																		<p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="color:#000000;">Referencias adicionales:</span></p>
																	</div>
																</div>
															</td>
														</tr>
													...
													<table class="text_block block-5" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:5px;padding-top:5px;">
																<div style="font-family: Tahoma, Verdana, sans-serif">
																	<div class style="font-size: 12px; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
																		<p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">Declaro dicho domicilio como actual y legal ante cualquier notificación o control de la Empresa,<br>comprometiéndome a comunicar fehacientemente dentro de las cuarenta y ocho horas, su cambio o<br>modificación.</p>
																	</div>
																</div>
															</td>
														</tr>
													...
													<table class="text_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-top:5px;">
																<div style="font-family: Tahoma, Verdana, sans-serif">
																	<div class style="font-size: 12px; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
																		<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;">{{ $item->apellido_pa}} {{ $item->apellido_ma}}  {{ $item->nombres}}</p>
																	</div>
																</div>
															</td>
														</tr>
